...
title: "Statements | Documentation"
---
...
## [Loop Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Loop-Statements)
...
Control flow in a loop statement can be changed by a `break` statement and a `continue` statement and is discussed in [Break Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements#Break-Statement) and [Continue Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements#Continue-Statement) below.
...
### [For-In Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#For-In-Statement)
...
The value of the _condition_ must be of type `Bool` or a type bridged to `Bool`. The condition can also be an optional binding declaration, as discussed in [Optional Binding](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics#Optional-Binding).
...
### [Repeat-While Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Repeat-While-Statement)
...
## [Branch Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Branch-Statements)
...
Control flow in an `if` statement or a `switch` statement can be changed by a `break` statement and is discussed in [Break Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements#Break-Statement) below.
...
The value of any condition in an `if` statement must be of type `Bool` or a type bridged to `Bool`. The condition can also be an optional binding declaration, as discussed in [Optional Binding](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics#Optional-Binding).
...
The value of any condition in a `guard` statement must be of type `Bool` or a type bridged to `Bool`. The condition can also be an optional binding declaration, as discussed in [Optional Binding](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics#Optional-Binding).
...
#### [Switch Statements Must Be Exhaustive](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Switch-Statements-Must-Be-Exhaustive)
...
#### [Switching Over Future Enumeration Cases](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Switching-Over-Future-Enumeration-Cases)
...
## [Control Transfer Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Control-Transfer-Statements)
...
### [Break Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Break-Statement)
...
For examples of how to use a `break` statement, see [Break](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow#Break) and [Labeled Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow#Labeled-Statements) in [Control Flow](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow).
...
For examples of how to use a `continue` statement, see [Continue](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow#Continue) and [Labeled Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow#Labeled-Statements) in [Control Flow](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow).

Grammar of a continue statement

_continue-statement_ → **`continue`** _label-name_ _?_

### [Fallthrough Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Fallthrough-Statement)
...
For an example of how to use a `fallthrough` statement in a `switch` statement, see [Control Transfer Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow#Control-Transfer-Statements) in [Control Flow](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/controlflow).

Grammar of a fallthrough statement

_fallthrough-statement_ → **`fallthrough`**

### [Return Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Return-Statement)
...
### [Throw Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Throw-Statement)
...
For an example of how to use a `throw` statement, see [Propagating Errors Using Throwing Functions](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/errorhandling#Propagating-Errors-Using-Throwing-Functions) in [Error Handling](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/errorhandling).

Grammar of a throw statement

_throw-statement_ → **`throw`** _expression_

## [Defer Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Defer-Statement)
...
## [Do Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Do-Statement)
...
For more information about working with errors that have explicit types, see [Specifying the Error Type](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/errorhandling#Specifying-the-Error-Type).
...
To ensure that an error is handled, use a `catch` clause with a pattern that matches all errors, such as a wildcard pattern ( `_`). If a `catch` clause doesn’t specify a pattern, the `catch` clause matches and binds any error to a local constant named `error`. For more information about the patterns you can use in a `catch` clause, see [Patterns](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/patterns).

To see an example of how to use a `do` statement with several `catch` clauses, see [Handling Errors](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/errorhandling#Handling-Errors).
...
## [Compiler Control Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Compiler-Control-Statements)
...
### [Conditional Compilation Block](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Conditional-Compilation-Block)
...
For information about how you can wrap explicit member expressions in conditional compilation blocks, see [Explicit Member Expression](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/expressions#Explicit-Member-Expression).
...
### [Compile-Time Diagnostic Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Compile-Time-Diagnostic-Statement)
...
## [Availability Condition](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/\#Availability-Condition)
...
- [Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/#app-top)
- [Loop Statements](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/#Loop-Statements)
- [For-In Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/#For-In-Statement)
- [While Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/#While-Statement)
- [Repeat-While Statement](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/statements/#Repeat-While-Statement)
