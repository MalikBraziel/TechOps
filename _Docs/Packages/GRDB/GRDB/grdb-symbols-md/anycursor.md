...
> Creates a cursor that wraps the given closure in its    method.
...
> Creates a new cursor that wraps and forwards operations to   .
...
> Creates a new cursor whose elements are elements of   .
