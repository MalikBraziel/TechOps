...
- `barrierwritewithouttransaction(_:)-62pqm`
- `close()`
- `configuration`
...
- `writewithouttransaction(_:)-7lcwx`
...
> Returns a connection to an in-memory copy of the database at   .
...
> Returns a connection to a private, temporary, on-disk copy of the   database at   .
